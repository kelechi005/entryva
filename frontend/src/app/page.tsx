...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const navTimer = setTimeout(() => router.replace('/login'), 1600);
    return () => {
    ...
    >
      <div className="relative flex h-28 w-28 items-center justify-center">
        ...
        <img
          ...
          alt=""
          className="relative h-16 w-16 rounded-2xl shadow-glow"
        />
      </div>
      ...
      <img
        ...
        alt="Entryva"
        className="h-7 w-auto opacity-0 animate-fade-up [animation-delay:200ms] [animation-fill-mode:forwards]"
      />

      <div className="flex items-center gap-1.5 opacity-0 animate-fade-up [animation-delay:400ms] [animation-fill-mode:forwards]">
